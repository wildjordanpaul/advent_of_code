...
fun String.splitInts(delimiter: Regex = DEFAULT_DELIMITER) = split(delimiter).map(String::trim).filter(String::isNotBlank).map(String::toInt)
fun String.splitLongs(delimiter: String) = split(delimiter).map(String::trim).filter(String::isNotBlank).map(String::toLong)
fun String.splitLongs(delimiter: Regex = DEFAULT_DELIMITER) = split(delimiter).map(String::trim).filter(String::isNotBlank).map(String::toLong)
fun String.splitDoubles(delimiter: String) = split(delimiter).map(String::trim).filter(String::isNotBlank).map(String::toDouble)
fun String.splitDoubles(delimiter: Regex = DEFAULT_DELIMITER) = split(delimiter).map(String::trim).filter(String::isNotBlank).map(String::toDouble)
